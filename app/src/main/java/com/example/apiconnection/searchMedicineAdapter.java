...
import com.example.apiconnection.ModelResponses.Search.items;
...
public class searchMedicineAdapter  extends RecyclerView.Adapter<searchMedicineAdapter.ViewHolder>{
    ...
    @NonNull
    @Override
    public searchMedicineAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
