...
public class Data {
    ...
    public List<com.example.apiconnection.ModelResponses.Search.items> getItems() {
        return items;
    }

    public void setItems(List<com.example.apiconnection.ModelResponses.Search.items> items) {
        this.items = items;
    }
